# -*- coding: utf-8 -*-
#
# InferPy documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'InferPy', u'InferPy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'InferPy', u'InferPy Documentation',
     author, 'InferPy', 'One line description of project.',
     'Miscellaneous'),
]
